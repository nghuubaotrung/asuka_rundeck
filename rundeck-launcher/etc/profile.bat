...
set RDECK_BASE=/Users/nguyen_huubaotrung/Tools/rundeck/rundeck-launcher

set JAVA_HOME=/Library/Java/JavaVirtualMachines/jdk1.7.0_80.jdk/Contents/Home/jre
